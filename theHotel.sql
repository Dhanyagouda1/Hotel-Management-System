...
-- Password:   `password`
--
DROP DATABASE IF EXISTS theHotel;
CREATE DATABASE IF NOT EXISTS theHotel;

DROP USER IF EXISTS'theHotel_user'@'%';
CREATE USER IF NOT EXISTS 'theHotel_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON bluebirdhotel.* TO 'theHotel_user'@'%';
USE theHotel;
...
(41, 'Dhanya Bharadwaj', 'dhanyabharadwaj2004@gmail.com', 'Single Room', 'Single', 1, '2024-11-09', '2024-11-10', 1, 1000.00, 10.00, 'Room only', 0.00, 1010.00);
...
(41, 'Dhanya Bharadwaj', 'dhanyabharadwaj2004@gmail.com', 'India', '8762624188', 'Single Room', 'Single', 'Room only', '1', '2024-11-09', '2024-11-10', 1, 'Confirm');
...
(1, 'Dhanya Bharadwaj', 'dhanyabharadwaj2004@gmail.com', '123');
